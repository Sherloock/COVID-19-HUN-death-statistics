class Deaths {
  static dataCheck() {
    ...
    let data = Deaths.getData().sort(Deaths.compareSorsz);
  ...
  static getData() {
    return [
      ...
      },
      {
        ...
        Kor: 74,
        Alapbetegségek:
          'iszkémiás szívbetegség, cukorbetegség, veseelégtelenség',
      },
      {
        Sorszám: 234,
        Nem: 'Férfi',
      ...
      },
      {
        ...
        Kor: 83,
        Alapbetegségek:
          'magas vérnyomás, cukorbetegség, daganatos megbetegedés',
      },
      {
        Sorszám: 186,
        Nem: 'Férfi',
      ...
      },
      {
        ...
        Kor: 84,
        Alapbetegségek:
          'magas vérnyomás,vastagbélrák, krónikus veseelégtelenség',
      },
      {
        Sorszám: 151,
        Nem: 'Férfi',
      ...
      },
      {
        ...
        Kor: 97,
        Alapbetegségek:
          'tartós légcsőkanül, magas vérnyomás, pitvarfibrilláció',
      },
      {
        Sorszám: 114,
        Nem: 'Férfi',
      ...
      },
      {
        ...
        Kor: 83,
        Alapbetegségek:
          'magas vérnyomás, szív-és érrendszeri betegség, dementia',
      },
      {
        Sorszám: 103,
        Nem: 'Férfi',
